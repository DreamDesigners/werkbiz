        ...
        <>
            ...
            <div class="useable-tools-section-three mt-200 mb-200 md-mt-100 md-mb-80">
                ...
                <div class="logo-wrapper d-flex flex-wrap justify-content-center align-items-center">
                    <div style={{ background: '#314FA5' }} class="logo d-flex align-items-center justify-content-center"><img src="assets/home/brand1.png" alt="" style={{ padding: '10px' }} /></div>
                    <div style={{ background: '#377DFF' }} class="logo d-flex align-items-center justify-content-center"><img src="assets/home/brand2.png" alt="" style={{ padding: '10px' }} /></div>
                    <div style={{ background: '#314FA5' }} class="logo d-flex align-items-center justify-content-center"><img src="assets/home/brand3.png" alt="" style={{ padding: '10px' }} /></div>
                    <div style={{ background: '#FFB61D' }} class="logo d-flex align-items-center justify-content-center"><img src="assets/home/brand5.png" alt="" style={{ padding: '10px' }} /></div>
                    <div style={{ background: '#E06A4B' }} class="logo d-flex align-items-center justify-content-center"><img src="assets/home/brand2.png" alt="" style={{ padding: '10px' }} /></div>
                    <div style={{ background: '#377DFF' }} class="logo d-flex align-items-center justify-content-center"><img src="assets/home/brand3.png" alt="" style={{ padding: '10px' }} /></div>
                    <div style={{ background: '#E06A4B' }} class="logo d-flex align-items-center justify-content-center"><img src="assets/home/brand3.png" alt="" style={{ padding: '10px' }} /></div>
